...
def init_worker(contentdatapath, dictarticleinfo):
	global contentdata_path, dict_article_info

	contentdata_path = contentdatapath
	dict_article_info = dictarticleinfo
...
def main():
    ...
    if dataset == 'adressa':
        ...
        with ThreadPool(processes=8, initializer=init_worker, initargs=(contentdata_path, dict_article_info)) as pool:
